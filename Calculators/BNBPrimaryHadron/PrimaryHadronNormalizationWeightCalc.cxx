...
namespace evwgh {
  ...
  public:
    ...
    std::pair< bool, double > MiniBooNEWeightCalc(bsim::Dk2Nu & e, double rand);
    std::pair< bool, double > MicroBooNEWeightCalc(bsim::Dk2Nu & e, double rand);
    virtual std::vector<std::vector<double> > GetWeight(bsim::Dk2Nu & e);
  ...
  std::vector<std::vector<double> > PrimaryHadronNormalizationWeightCalc::GetWeight(bsim::Dk2Nu & e)
  {
    ...
    for(unsigned int inu = 0; inu < 1; inu++){
      ...
      if (e.tgtexit.tptype != fprimaryHad){	
  ...
  ////
  std::pair< bool, double> PrimaryHadronNormalizationWeightCalc::MiniBooNEWeightCalc(bsim::Dk2Nu& e, double rand){
  ...
  ////
  std::pair<bool, double> PrimaryHadronNormalizationWeightCalc::MicroBooNEWeightCalc(bsim::Dk2Nu& e, double rand){
    
    throw cet::exception(__FUNCTION__) << GetName()
				       << " MicroBooNE Weight Calc is Not Configured."<<std::endl;	  
  ...
  std::vector< double > PrimaryHadronNormalizationWeightCalc::MiniBooNERandomNumbers(std::string pdg){
    ...
    if(pdg.compare("kminus") == 0){	 
      ...
      throw cet::exception(__FUNCTION__) << GetName()
					 << " Normalization MiniBooNE random numbers are only configured for negatively charged kaons"<<std::endl;	  
    }
